...
*** Last modification date: 2018.02.20.
**********************************************************************************
*/
...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KEYMAP(\
        TRNS,     MPRV,MPLY,MNXT,MSTP,TRNS,TRNS,TRNS,TRNS, F9, F10 , F11,TRNS,      TRNS,SLCK,PWR, \
        TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,      TRNS,TRNS,TRNS, \
        TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,      TRNS,TRNS,TRNS, \
        CLCK,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,     TRNS,                      \
